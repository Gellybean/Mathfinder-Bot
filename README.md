...
- Tools for DMs, including the ability to evaluate character sheets, secret rolls, initiative tracking, a bestiary with 3,200 entries with pre-programmed buttons for attacks.
