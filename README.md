...
- Modifiable presets for weapons, armor, and shapes(beast shape, alter self, etc)
...
- Bestiary with 3,200 entries containing pre-programmed melee attacks. This includes Paizo and Frog God Games.  
