...
- Turn expressions into buttons which you can shape into rows and grids.
- Modifiable presets for weapons, armor, and shapes.
...
MF-Bot comes with many different presets for things like equipment, creatures, stat modifiers including spells and conditions. Bring up attacks for different creatures, as well as beast shape and similar effects.
...
As a last example, we can combine it with 
 - an attack roll: `ATK_STR + th(PA_ATK)` 
 - and a damage roll: `DMG_STR + th(PA_DMG)`. 

I would suggest putting weapon expressions into a `/row`, as opposed to directly into your character sheet. You can do this by using `/var` and `Set-Row`.
