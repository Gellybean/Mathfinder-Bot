...
Mathfinder currently supports a few options for character imports. This will override any pertinent values, so that anytime your stats would change, you can easily update your sheet. This way you can use apps more suited for character management while keeping your expressions up to date.
