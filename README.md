...
## Getting Started
**NOTE**—You don't need to create a character to utilize most commands. The first time you use [`/eval`](https://github.com/Gellybean/Mathfinder-Bot/wiki/eval), it will generate an empty statblock.
